...
const leftArrow = document.querySelector('.back-btn'); const userTitle = document.querySelector('.username'); const reposSection = document.querySelector('.repos');
...
const getRepoName = (event) => {
    ...
    const repoName = repoCard.querySelector('.repos__card__info-container__repo-name');
